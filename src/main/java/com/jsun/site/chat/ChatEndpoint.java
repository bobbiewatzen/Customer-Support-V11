package com.jsun.site.chat;

import com.jsun.site.SessionRegistry;
import com.jsun.site.UserPrincipal;
...
public class ChatEndpoint
{
    ...
    {
        private static final String HTTP_SESSION_KEY = "com.jsun.ws.http.session";
        private static final String PRINCIPAL_KEY = "com.jsun.ws.user.principal";
